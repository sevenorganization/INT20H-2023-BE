package org.sevenorganization.int20h2023be.security.userdetails;
...
public class DefaultUserDetails implements OAuth2User, UserDetails {
    ...
    public DefaultUserDetails(Long id, String email, String password, boolean enabled , Collection<? extends GrantedAuthority> authorities, AuthProvider authProvider) {
        this.id = id;
        this.email = email;
