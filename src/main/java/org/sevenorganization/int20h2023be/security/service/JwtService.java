...
import org.sevenorganization.int20h2023be.exception.ReAuthenticationRequiredException;
import org.sevenorganization.int20h2023be.model.dto.AuthResponseDto;
import org.sevenorganization.int20h2023be.model.dto.RefreshTokenRequestDto;
...
import org.sevenorganization.int20h2023be.security.service.impl.DefaultRefreshTokenService;
...
public class JwtService {
    ...
    public String generateAccessToken(DefaultUserDetails defaultUserDetails) {
        return JWT.create()
                ...
                .withClaim("provider", defaultUserDetails.getAuthProvider().toString())
